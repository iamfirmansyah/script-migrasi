...
<div class="col-xl-6">
	...
	<div class="card card-custom gutter-b card-stretch bg-info">
		<div class="card-body d-flex p-0">
			<div class="flex-grow-1 bg-info p-12 pb-40 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: right bottom; background-size: 55% auto; background-image: url({{asset('admin/assets/media/svg/humans/custom-6.svg')}})">
				<h3 class="text-inverse-info pb-5 font-weight-bolder">Start Now</h3>
				<p class="text-inverse-info pb-5 font-size-h6">
					 Offering discounts for better <br/>online a store can loyalty <br/>weapon into driving</p>
