		...
		<div id="kt_header_mobile" class="header-mobile bg-primary header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" src="admin/assets/media/logos/logo-letter-9.png" class="max-h-30px" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<a href="index.html" class="mr-20">
										<img alt="Logo" src="admin/assets/media/logos/logo-letter-9.png" class="max-h-35px" />
									</a>
									<!--end::Logo-->
								...
								<div class="topbar">
									...
									<div class="dropdown">
										...
										<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
											<form>
												<!--begin::Header-->
												<div class="d-flex align-items-center py-10 px-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(admin/assets/media/misc/bg-1.jpg)">
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">Perdoski</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
