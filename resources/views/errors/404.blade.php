...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link href="{{asset('admin/assets/css/pages/error/error-6.css?v=7.0.5')}}" rel="stylesheet" type="text/css" />
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{asset('admin/assets/media/error/bg6.jpg')}});">
				...
				<div class="d-flex flex-column flex-row-fluid text-center">
					...
					<p class="display-4 font-weight-bold text-white">Looks like something went wrong. <br> Page Not Found</p>
				</div>
				<!--end::Content-->
			</div>
			<!--end::Error-->
